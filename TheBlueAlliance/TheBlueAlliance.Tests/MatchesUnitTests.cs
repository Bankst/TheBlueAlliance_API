...
namespace TheBlueAlliance.Tests
{
    ...
    //
    //         Assert.AreEqual(expectedScoreBreakdownBlue_Tote_Count_Far, actualMatchInformation.score_breakdown.Score.tote_count_far, "Score Tote count far is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_Tote_Count_Near, actualMatchInformation.score_breakdown.Score.tote_count_near, "Score Tote count near is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_container_count_level1, actualMatchInformation.score_breakdown.Score.container_count_level1, "Score Container count level 1 is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_container_count_level2, actualMatchInformation.score_breakdown.Score.container_count_level2, "Score Container count level 2 is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_container_count_level3, actualMatchInformation.score_breakdown.Score.container_count_level3, "Score Container count level 3 is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_container_count_level4, actualMatchInformation.score_breakdown.Score.container_count_level4, "Score Container count level 4 is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_container_count_level5, actualMatchInformation.score_breakdown.Score.container_count_level5, "Score Container count level 5 is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_container_count_level6, actualMatchInformation.score_breakdown.Score.container_count_level6, "Score Container count level 6 is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_teleop_points, actualMatchInformation.score_breakdown.Score.teleop_points, "Score Teleop points are not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_auto_points, actualMatchInformation.score_breakdown.Score.auto_points, "Blu eAuto points are not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_total_points, actualMatchInformation.score_breakdown.Score.total_points, "Score Total points are not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_tote_set, actualMatchInformation.score_breakdown.Score.tote_set, "Score Tote set is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_container_set, actualMatchInformation.score_breakdown.Score.container_set, "Score Container set is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_foul_count, actualMatchInformation.score_breakdown.Score.foul_count, "Score Foul Count is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_container_pointers, actualMatchInformation.score_breakdown.Score.container_points, "Score Container points are not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_adjust_points, actualMatchInformation.score_breakdown.Score.adjust_points, "Score adjust points are not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_litter_count_unprocessed, actualMatchInformation.score_breakdown.Score.litter_count_unprocessed, "Score litter count unprocessed is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_robot_set, actualMatchInformation.score_breakdown.Score.robot_set, "Score robot set is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_litter_count_container, actualMatchInformation.score_breakdown.Score.litter_count_container, "Score litter count container is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_tote_points, actualMatchInformation.score_breakdown.Score.tote_points, "Score tote points are not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_foul_points, actualMatchInformation.score_breakdown.Score.foul_points, "Score foul points are not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_tote_stack, actualMatchInformation.score_breakdown.Score.tote_stack, "Score tote stack is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_litter_count_landfill, actualMatchInformation.score_breakdown.Score.litter_count_landfill, "Score litter count landfill is not as expected!");
    //         Assert.AreEqual(expectedScoreBreakdownBlue_litter_points, actualMatchInformation.score_breakdown.Score.litter_points, "Score litter points are not as expected!");
    //
    ...
    //
    //         Assert.AreEqual(expectedAlliancesBlueScore, actualMatchInformation.alliances.Score.score, "Score total score is not as expected!");
    //         Assert.AreEqual(expectedAlliancesBlue0, actualMatchInformation.alliances.Score.teams[0], "Score team alliances are not as expected!");
    //         Assert.AreEqual(expectedAlliancesBlue1, actualMatchInformation.alliances.Score.teams[1], "Score team alliances are not as expected!");
    //         Assert.AreEqual(expectedAlliancesBlue2, actualMatchInformation.alliances.Score.teams[2], "Score team alliances are not as expected!");
